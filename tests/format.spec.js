...
it('should format like debug with colors', () => {
  ...
  expect(res[MESSAGE]).toMatchInlineSnapshot(`"[34m[1mV[22m[39m [1m[38;2;204;51;51mconnected[39m[22m db [38;2;204;51;51m+0ms[39m"`)
})
...
it('should format like debug with colors and rest object', () => {
  ...
  expect(res[MESSAGE]).toMatchInlineSnapshot(`"[34m[1mV[22m[39m [1m[38;2;204;51;51mconnected[39m[22m db { myKey: [32m'myValue'[39m } [38;2;204;51;51m+0ms[39m"`)
})
it('should format like debug with colors and message as object', () => {
  ...
  expect(res[MESSAGE]).toMatchInlineSnapshot(`"[34m[1mV[22m[39m [1m[38;2;204;51;51mconnected[39m[22m { foo: [32m'bar'[39m } { other: [32m'test'[39m } [38;2;204;51;51m+0ms[39m"`)
})
